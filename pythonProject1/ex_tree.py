...
pre_order(root)          # root 부터 전위순회(1 2 4 7 12)
pre_order(3)             # 3번부터 전위순회(3 5 8 9 6 10 11 13)
post_order(1)            # 1번부터 후위순회(12 7 4 2 8 9 5 10 13 11 6 3 1)
